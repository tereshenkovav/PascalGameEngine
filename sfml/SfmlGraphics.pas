...
{$ENDIF}
  ...
  procedure SfmlRenderWindowSetVerticalSyncEnabled(RenderWindow: PSfmlRenderWindow; Enabled: Integer); cdecl; external CSfmlGraphicsLibrary name 'sfRenderWindow_setVerticalSyncEnabled';
...
{$ENDIF}
  ...
  procedure SfmlTextureSetSmooth(Texture: PSfmlTexture; Smooth: Integer); cdecl; external CSfmlGraphicsLibrary name 'sfTexture_setSmooth';
  function SfmlTextureIsSmooth(const Texture: PSfmlTexture): Integer; cdecl; external CSfmlGraphicsLibrary name 'sfTexture_isSmooth';
...
begin
  if Enabled then
    SfmlRenderWindowSetVerticalSyncEnabled(FHandle, 1)
  else
    SfmlRenderWindowSetVerticalSyncEnabled(FHandle, 0);
end;
...
begin
  Result := SfmlTextureIsSmooth(FHandle)=1;
end;
...
begin
  if Smooth then
    SfmlTextureSetSmooth(FHandle, 1)
  else
    SfmlTextureSetSmooth(FHandle, 0);
end;
