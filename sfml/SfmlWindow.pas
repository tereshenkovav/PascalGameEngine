...
{$ELSE}
  ...
  procedure SfmlWindowSetVerticalSyncEnabled(Window: PSfmlWindow; Enabled: Integer); cdecl; external CSfmlWindowLibrary name 'sfWindow_setVerticalSyncEnabled';
...
begin
  if Enabled then
    SfmlWindowSetVerticalSyncEnabled(FHandle, 1)
  else
    SfmlWindowSetVerticalSyncEnabled(FHandle, 0);
end;
